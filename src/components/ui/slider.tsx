...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ref={ref}
    className={cn(
      'relative flex w-full touch-none select-none items-center bg-yellow-500',
      className,
    )}
    {...props}
  >
    <SliderPrimitive.Track className=" relative h-2 w-full grow overflow-hidden rounded-full bg-orange-600 dark:bg-slate-800">
      <SliderPrimitive.Range className="absolute h-full bg-yellow-500 dark:bg-slate-50" />
