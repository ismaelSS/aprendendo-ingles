...
function getNumberInWords(num: number): { words: string; wordsSpeak: string } {
  ...
  const onesSpeak = [
    '', 'uãn', 'tiú', 'thríí', 'fór', 'faiv', 'saecs', 'séven', 'eit', 'nain',
    'tén', 'ãleven', 'tuélv', 'thãrtíín', 'fórtíín', 'fiftíín', 'sicstíín', 'séventíín', 'eitíín', 'naintíín'
  ];

  const tensSpeak = [
    '', '', 'twêni', 'thãrri', 'fórtí', 'fiftí', 'sicstí', 'sevení', 'eirrí', 'naintí'
  ];

  const hundredsSpeak = [
    '', 'uãn rãndrid', 'tiú rãndrid', 'thríí rãndrid', 'fór rãndrid', 'faiv rãndrid', 'saecs rãndrid', 'séven rãndrid', 'eit rãndrid', 'nain rãndrid'
  ];
